...
class QueryTemplateImpl implements QueryTemplate {
    ...
    protected <T extends Record, ID> Model<T, ID> createModel(@Nonnull Class<T> type, boolean requirePrimaryKey) throws PersistenceException {
        ...
        return (Model<T, ID>) MODEL_CACHE.computeIfAbsent(type, key -> {
            ...
            if (foreignKey) {
                ...
                if (componentType.isRecord()) {
                    ...
                    if (REFLECTION.isAnnotationPresent(component, Name.class)) {
                        throw new SqlTemplateException(STR."Name annotation is not allowed on @PK or @Inline records: \{component.getDeclaringRecord().getSimpleName()}.\{component.getName()}");
                    }
