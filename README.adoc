...
[source,groovy]
----
implementation 'st.orm:storm-java21:1.7.2'
runtimeOnly 'st.orm:storm-core:1.7.2'
----
Gradle (Kotlin)::
+
[source,groovy]
----
implementation 'st.orm:storm-kotlin:1.7.2'
runtimeOnly 'st.orm:storm-core:1.7.2'
----
====
...
[source,groovy]
----
runtimeOnly 'st.orm:storm-oracle:1.7.2'
----
====
...
[source,groovy]
----
annotationProcessor 'st.orm:storm-metamodel-processor:1.7.2'
----
====
...
[source,groovy]
----
implementation 'st.orm:storm-jackson:1.7.2'
----
Gradle (Kotlinx Serialization)::
+
[source,groovy]
----
implementation 'st.orm:storm-kotlinx-serialization:1.7.2'
----
====
...
[source,groovy]
----
implementation 'st.orm:storm-spring:1.7.2'
----
Maven (Kotlin)::
+
[source,xml]
...
[source,groovy]
----
implementation 'st.orm:storm-kotlin-spring:1.7.2'
----
====
