...
public class EntityRepositoryImpl<E extends Record & Entity<ID>, ID>
    ...
    public EntityRepositoryImpl(@Nonnull ORMTemplate orm, @Nonnull Model<E, ID> model) {
        super(orm, model);
    ...
    /**
     * Determines if the entity's primary key represents a default value.
     *
     ...
     * @return true if the primary key is a default value, false otherwise.
     */
