...
* *Type-safe*: Storm’s query builder mirrors SQL, providing a type-safe, intuitive experience
...
[source,groovy]
----
implementation 'st.orm:storm-java21:1.4.0'
runtimeOnly 'st.orm:storm-core:1.4.0'
----
Gradle (Kotlin)::
+
[source,groovy]
----
implementation 'st.orm:storm-kotlin:1.4.0'
runtimeOnly 'st.orm:storm-core:1.4.0'
----
====
...
[source,kotlin]
----
userRepository.selectAll().use { users ->
    val userIds: List<Int> = users
      .map { it.id }
      .toList()
    ...
}
...
[source,groovy]
----
runtimeOnly 'st.orm:storm-oracle:1.4.0'
----
====
...
[source,groovy]
----
annotationProcessor 'st.orm:storm-metamodel-processor:1.4.0'
----
====
...
[source,groovy]
----
implementation 'st.orm:storm-json:1.4.0'
----
====
...
[source,groovy]
----
implementation 'st.orm:storm-spring:1.4.0'
----
Maven (Kotlin)::
+
[source,xml]
...
[source,groovy]
----
implementation 'st.orm:storm-kotlin-spring:1.4.0'
----
====
...
class AcmeRepositoryBeanFactoryPostProcessor : RepositoryBeanFactoryPostProcessor() {
    ...
    override val repositoryBasePackages: Array<String> get() = arrayOf("com.acme.repository")
}
----
====