...
CREATE TABLE animal (id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, dtype VARCHAR2(50) NOT NULL, name VARCHAR2(255), indoor NUMBER(1), weight NUMBER);
...
DROP TABLE joined_cat CASCADE CONSTRAINTS;
DROP TABLE joined_dog CASCADE CONSTRAINTS;
DROP TABLE joined_animal CASCADE CONSTRAINTS;

CREATE TABLE joined_animal (
    id NUMBER GENERATED BY DEFAULT AS IDENTITY,
    dtype VARCHAR2(50) NOT NULL,
    name VARCHAR2(255),
    CONSTRAINT pk_joined_animal PRIMARY KEY (id)
);
CREATE TABLE joined_cat (
    id NUMBER NOT NULL,
    indoor NUMBER(1),
    CONSTRAINT pk_joined_cat PRIMARY KEY (id)
);
CREATE TABLE joined_dog (
    id NUMBER NOT NULL,
    weight NUMBER,
    CONSTRAINT pk_joined_dog PRIMARY KEY (id)
);
...
DROP TABLE nodsc_cat CASCADE CONSTRAINTS;
DROP TABLE nodsc_dog CASCADE CONSTRAINTS;
DROP TABLE nodsc_bird CASCADE CONSTRAINTS;
DROP TABLE nodsc_animal CASCADE CONSTRAINTS;

CREATE TABLE nodsc_animal (
    id NUMBER GENERATED BY DEFAULT AS IDENTITY,
    name VARCHAR2(255),
    CONSTRAINT pk_nodsc_animal PRIMARY KEY (id)
);
CREATE TABLE nodsc_cat (
    id NUMBER NOT NULL,
    indoor NUMBER(1),
    CONSTRAINT pk_nodsc_cat PRIMARY KEY (id)
);
CREATE TABLE nodsc_dog (
    id NUMBER NOT NULL,
    weight NUMBER,
    CONSTRAINT pk_nodsc_dog PRIMARY KEY (id)
);
CREATE TABLE nodsc_bird (
    id NUMBER NOT NULL,
    CONSTRAINT pk_nodsc_bird PRIMARY KEY (id)
);
