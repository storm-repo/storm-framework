...
/**
 * Tests for {@link OracleSqlDialect#multiColumnExpression}, which uses the compact row value constructor syntax
 * (e.g., {@code (a, b) > (?, ?)}) since Oracle supports multi-value tuples.
 *
 * @since 1.9
 */
public class OracleMultiColumnExpressionTest {

    private static final OracleSqlDialect DIALECT = new OracleSqlDialect();
