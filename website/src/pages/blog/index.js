...
const BLOG_FILTER_CSS = `
  /* Capped to the same measure as the hero copy so the row wraps before it
     reaches the artwork, rather than running into it at narrow desktop widths. */
  .storm-tut .bfilters{display:flex;gap:12px;flex-wrap:wrap;margin-top:28px;max-width:700px}
  ...
  .storm-tut .bchip:focus-visible{outline:2px solid var(--accent);outline-offset:3px;color:#e9eaf7}
