...
${charts}
  ...
  <ul>
    ...
    <li><b>Extra shapes count as query code.</b> A library may define a purpose-built entity shape for a workload on top of its regular entity for that type, subject to the same three tests. Because such a shape exists to speed a query, its lines count toward the query comparison rather than the model comparison.</li>
