...
CREATE TABLE pet (
    id integer DEFAULT NEXT VALUE FOR pet_id_seq NOT NULL PRIMARY KEY,
    name varchar(255),
    birth_date date,
    owner_id integer,
    type_id integer
...
CREATE TABLE animal (id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, dtype varchar(50) NOT NULL, name varchar(255), indoor boolean, weight integer);
...
CREATE TABLE joined_animal (id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, dtype varchar(50) NOT NULL, name varchar(255));
...
CREATE TABLE nodsc_animal (id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name varchar(255));
