        ...
        try {
            ...
            return (Model<T, ID>) MODEL_CACHE.computeIfAbsent(type, _ -> {
                ...
                for (var component : type.getRecordComponents()) {
                    ...
                    boolean autoGenerated = primaryKey && isAutoGenerated(component);
                    Metamodel<T, ?> model = Metamodel.of(type, component.getName());
                    var list = createColumns(builder, component, primaryKey, autoGenerated,
                            false, index, primaryKeyIndex);
                    columns.addAll(list);
