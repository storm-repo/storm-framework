...
public interface SqlInterceptor extends AutoCloseable {
     ...
     */
    static void registerGlobalInterceptor(@Nonnull Consumer<Sql> consumer) {
        SqlInterceptorManager.registerGlobalInterceptor(consumer);
    }
     ...
     */
    static void unregisterGlobalInterceptor(@Nonnull Consumer<Sql> consumer) {
        SqlInterceptorManager.unregisterGlobalInterceptor(consumer);
    }
     ...
     */
    static SqlInterceptor intercept(@Nonnull Consumer<Sql> consumer) {
