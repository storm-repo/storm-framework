...
public abstract class MergeEntityRepositoryImpl<E extends Entity<ID>, ID> extends EntityRepositoryImpl<E, ID> {
    ...
    protected MergeEntityRepositoryImpl(ORMTemplate ormTemplate, Model<E, ID> model) {
    ...
    private TemplateString castColumn(TemplateString parameter, Column column) {
     ...
     */
    protected TemplateString mergeSelect(E entity) {
     ...
     */
    protected TemplateString mergeSelect(BindVars bindVars) {
     ...
     */
    protected TemplateString mergeUpdate(AtomicBoolean versionAware) {
        var dialect = ormTemplate.dialect();
        var duplicates = new HashSet<>();   // Compound PKs may also have their columns included as stand-alone fields. Only include them once.
    ...
    private TemplateString mergeStatement(TemplateString mergeSelect, AtomicBoolean versionAware) {
        return flatten(raw("""
                MERGE INTO \0 t
                USING (\0) src
