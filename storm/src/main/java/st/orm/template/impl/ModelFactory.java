...
final class ModelFactory {
    ...
    private static List<Column> createColumns(@Nonnull ModelBuilder builder,
        ...
        try {
            ...
            return List.of(new ColumnImpl(columnName, index.getAndIncrement(), componentType, primaryKey, autoGenerated,
                    foreignKey, nullable, insertable, updatable, version, lazy));
        } catch (SqlTemplateException e) {
            throw new PersistenceException(e);
        }
    }
