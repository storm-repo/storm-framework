...
create table owner (id NUMBER GENERATED BY DEFAULT AS IDENTITY, first_name varchar(255), last_name varchar(255), address varchar(1024), telephone varchar(255), primary key (id));
create table pet (id NUMBER GENERATED BY DEFAULT AS IDENTITY, name varchar(255), birth_date date, owner_id integer, type_id integer, primary key (id));
create table pet_type (id NUMBER GENERATED BY DEFAULT AS IDENTITY, name varchar(255), primary key (id));
create table specialty (id NUMBER GENERATED BY DEFAULT AS IDENTITY, name varchar(255), primary key (id));
create table vet (id NUMBER GENERATED BY DEFAULT AS IDENTITY, first_name varchar(255), last_name varchar(255), primary key (id));
create table vet_specialty (vet_id integer, specialty_id integer not null, primary key (vet_id, specialty_id));
create table visit (id NUMBER GENERATED BY DEFAULT AS IDENTITY, visit_date date, description varchar(255), pet_id integer not null, primary key (id));
