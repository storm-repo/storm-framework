...
/**
 * Tests for {@link MySQLSqlDialect#multiColumnExpression}, which uses the compact row value constructor syntax
 * (e.g., {@code (a, b) > (?, ?)}) since MySQL supports multi-value tuples.
 *
 * @since 1.9
 */
public class MySQLMultiColumnExpressionTest {

    private static final MySQLSqlDialect DIALECT = new MySQLSqlDialect();
